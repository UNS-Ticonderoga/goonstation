...
var/global/list/soundCache = list(
	"modular_ticonderoga/sound/weapons/lar_shot.ogg" = 'modular_ticonderoga/sound/weapons/lar_shot.ogg',\
 	...
 	"sound/impact_sounds/crunchy_sizzle.ogg" = 'sound/impact_sounds/crunchy_sizzle.ogg',\
 	...
 	"sound/misc/announcement_curious.ogg" = 'sound/misc/announcement_curious.ogg',\
 	...
 	"sound/voice/creepyshriek_recording.ogg" = 'sound/voice/creepyshriek_recording.ogg',\
